...
<head>
    ...
    <link href="{{ asset('css/admin/dashboard/css/sb-admin-2.min.css') }}" rel="stylesheet">
</head>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">All Order</h6>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="/visitor/products" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Admin-1</span>
                                <img class="img-profile rounded-circle"
                                    src="{{ asset('images/admin/user.png') }}">
                            </a>
                ...
                <img src="{{ asset('images/admin/dashboard.jpg') }}" alt="" style="width: 100%; height: 100%">
            </div>
    ...
    <script src="{{ asset('css/admin/dashboard/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('css/admin/dashboard/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

    <script src={{ asset('js/admin/dashboard/js/sb-admin-2.min.js') }}></script>
