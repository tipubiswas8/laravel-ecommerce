...
<head>
    ...
    <script src="{{ asset('js/visitors/sidebar.js') }}"></script>
</head>
...
<body>
    ...
    {{-- Menu and sidebar --}}
    <button class="menuButton" onclick="showHideSitebar()"><i class='fa fa-bars' style='color: red'></i> Menu</button>
    ...
    {{-- Search-1 --}}
    <form class="d-inline-flex" style="width: 60%">
    ...
    {{-- Search-2 --}}
    {{-- <span>
    <form method="GET" action="{{ route('product.search') }}" class="d-inline">
        <input name="search" class="btn btn-light text-left col-md-4" type="search" placeholder="Search here">
        <button class="btn btn-outline-secondary bg-white ms-n5"><i class="fa fa-search"></i></button>
        <input class="btn ms-n6" type="reset" value="Clear">
    </form>
    </span> --}}
